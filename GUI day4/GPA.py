...
subject2_entry = ttk.Entry(root, width=10, textvariable= subject2_var)
subject2_entry.grid(row=1, column=1)

subject3_var = tk.IntVar()
subject3_entry = ttk.Entry(root, width=10, textvariable= subject3_var)
subject3_entry.grid(row=2, column=1)

subject4_var = tk.IntVar()
subject4_entry = ttk.Entry(root, width=10, textvariable= subject4_var)
subject4_entry.grid(row=3, column=1)

subject5_var = tk.IntVar()
subject5_entry = ttk.Entry(root, width=10, textvariable= subject5_var)
subject5_entry.grid(row=4, column=1)

subject6_var = tk.IntVar()
subject6_entry = ttk.Entry(root, width=10, textvariable= subject6_var)
...
def calculate():
    ...
    #Calculate weighted GPA using credit hours
    credit1 = credit1_var.get()
    credit2 = credit2_var.get()
    credit3 = credit3_var.get()
    credit4 = credit4_var.get()
    credit5 = credit5_var.get()
    credit6 = credit6_var.get()

    total_credits = credit1 + credit2 + credit3 + credit4 + credit5 + credit6
    total_points = (sub1 * credit1 + sub2 * credit2 + sub3 * credit3
                     + sub4 * credit4 + sub5 * credit5 + sub6 * credit6)

    if total_credits > 0:
        gpa = total_points / total_credits
        result_label.config(text='GPA: {:.2f}'.format(gpa))
    else:
        result_label.config(text='Enter credit hours to calculate GPA')
...
result_label.config(font=("Courier", 14))
